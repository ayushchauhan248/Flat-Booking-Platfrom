...
const Card2: FC<Props> = (props) =>{
return (
 <>
 <div className="flex">

<div className="w-1/2">
    <img className="w-full" src="https://cdn.pixabay.com/photo/2017/12/27/14/41/window-3042834__340.jpg" alt="Loading" />
</div>


<div className="bg-gray-100 w-1/2 px-10 py-28 space-x-2">

    <div className="flex">
        <div>
            <p className="text-2xl font-mono font-semibold">1. Sunshine Fourth Apartment</p>
        ...
        <div>
            <p className="text-gray-400"> (24) Reviews</p>
        </div>
        </div>
        ...
        <div >
            <button className="border-2 rounded border-solid hover:bg-gray-400 group ">
                <div className="flex p-2">
                    ...
                    <p className="pl-3 text-gray-400 group-hover:text-white">Contact Now</p>
                </div>
            </button>
        </div>
    </div>
